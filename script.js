document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('add-ingredient').addEventListener('click', function() {
        const ingredientSelects = document.querySelectorAll('select[multiple]');
        const ingredients = Array.from(ingredientSelects).flatMap(select => 
        ...
        .then(data => {
            ...
            document.getElementById('recipe_ingredients').value = parsedData.Recipe.Ingredients.join(', ');
...
document.getElementById('save-recipe').addEventListener('click', function() {
    ...
    const recipe_ingredients = document.getElementById('recipe_ingredients').value;
    const recipe_instructions = document.getElementById('recipe_instructions').value;
